      ...
      if (occasion === 'workout' && bottoms.length < 10) {
        ...
        try {
          const { data: workoutBottoms, error } = await supabase
            ...
            .or('product_name.ilike.%legging%,product_name.ilike.%jogger%,product_name.ilike.%athletic%,product_name.ilike.%workout%,product_name.ilike.%sport%,product_name.ilike.%gym%,product_name.ilike.%training%,product_name.ilike.%running%,product_name.ilike.%yoga%')
            .gte('price', categoryBudgets.bottoms.min)
            .lte('price', categoryBudgets.bottoms.max || 999)
            .limit(50)
