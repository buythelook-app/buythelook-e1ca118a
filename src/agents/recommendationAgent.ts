...
function generateContextualRecommendations(mood: string, event: string, styleData: string | null): string[] {
  ...
  const eventRecommendations: Record<string, string[]> = {
    work: [
      'תיק טוט עבודה (work tote)',
      'שעון קלאסי למקצועיות',
      'הימנע מתכשיטים גדולים'
    ],
    evening: [
      'תיק קלאץ (clutch) אלגנטי',
      'תכשיטים נוצצים (sparkly jewelry)',
      'נעלי עקב (heels)'
    ],
    casual: [
      'תיק כתף (shoulder bag)',
      'אביזרים פשוטים (simple items)'
    ],
    weekend: [
      'תיק קרוס-בודי קטן (small crossbody)',
      'נעליים נוחות (comfortable flats or sneakers)'
    ],
    daytonight: [
      'תיק טוט בינוני או קרוס-בודי מובנה',
      'נעלי עקב נמוך או שטוחות אלגנטיות',
      'תכשיטים בינוניים שניתנים לשינוי',
      'טיפ: החלף מבלייזר לקלאץ למראה ערב'
    ]
  };
