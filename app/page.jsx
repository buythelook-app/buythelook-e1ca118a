...
// <CHANGE> Simplified video component - removed motion.video, using standard video element
...
// <CHANGE> Simplified reveal component
...
// <CHANGE> Simplified typewriter input
  ...
  return (
    <div className={`relative ${className}`}>
      <input
        ...
        className="w-full bg-transparent border-0 border-b border-neutral-300 focus:border-neutral-900 text-neutral-900 text-lg md:text-xl py-4 outline-none transition-colors duration-300 placeholder:text-transparent"
        placeholder=""
      />
      {!value && !isFocused && (
        <div className="absolute left-0 top-1/2 -translate-y-1/2 text-neutral-400 text-lg md:text-xl pointer-events-none flex items-center">
          <span>{displayPlaceholder}</span>
          <motion.span
            animate={{ opacity: [1, 0] }}
            transition={{ duration: 0.5, repeat: Infinity }}
            className="ml-0.5 w-[2px] h-6 bg-neutral-400 inline-block"
          />
        </div>
      )}
    </div>
      ...
      <main className="relative ">
        ...
        <section className="w-full relative h-[100vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-6 md:px-8 max-w-5xl mx-auto">
            ...
            >
              {/* <span className="inline-flex items-center gap-4 text-[10px] md:text-[11px] font-medium tracking-[0.35em] uppercase text-white/50">
...
>
  How It Works
            ...
            >
              {[
                ...
                <div key={stat.label} className="text-center">
                  ...
                  <div className="text-[9px] tracking-[0.2em] uppercase text-white/40 mt-1">{stat.label}</div>
                </div>
              ))}
            </motion.div>
          </div>
        ...
        {/* ========== PERSONAL ATELIER SECTION - WHITE BACKGROUND ========== */}
        {/* <CHANGE> Changed from dark bg-neutral-950 to white bg-[#faf9f7] */}
        <section className="py-28 md:py-36 bg-[#faf9f7] border-y border-neutral-200">
          <div className="max-w-4xl mx-auto px-6 md:px-8">
            ...
            <div className="space-y-16">
              ...
              {/* SECTION 02: Filters - 3 Equal Columns */}
              <FadeInView delay={0.2}>
