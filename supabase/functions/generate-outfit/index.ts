...
function getColorPaletteForStyle(style: StylePreference): string[] {
  const colorPalettes = {
    ...
    // רומנטי - צבעים רכים ונשיים
    romantic: [
      '#FFB6C1', // ורוד בהיר
      '#FFC0CB', // ורוד
      '#FF69B4', // ורוד חם
      '#DB7093', // ורוד אפרסק כהה
      '#C71585', // מג'נטה בינוני
      '#E6E6FA', // לבנדר
      '#DDA0DD', // שזיף
      '#D8BFD8', // תיסטל
      '#FFE4E1', // ורוד מיסטי
    ...
    // מינימליסטי - צבעים נקיים וניטרליים
    minimalist: [
      '#000000', // שחור טהור
      '#1A1A1A', // שחור כמעט
      '#2D2D2D', // פחם כהה
    ...
    // קז'ואל - צבעים יומיומיים ונוחים
    casual: [
      '#4169E1', // כחול ג'ינס
      '#6495ED', // כחול קורנפלאוור
      '#87CEEB', // תכלת שמיים
      '#708090', // אפור צפחה
      '#556B2F', // זית כהה
      '#6B8E23', // זית
    ...
    // ספורטיבי - צבעים אנרגטיים ודינמיים
    sporty: [
      '#00BFFF', // כחול שמיים עמוק
      '#1E90FF', // כחול דודג'ר
      '#00CED1', // טורקיז כהה
      '#20B2AA', // ירוק ים בהיר
      '#3CB371', // ירוק ים בינוני
      '#32CD32', // ירוק ליים
      '#7FFF00', // שרטרוז
      '#ADFF2F', // ירוק צהוב
      '#FFFF00', // צהוב
